...
namespace FIT5032_Assign1_v6.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var customers = db.CustomerSet.Where(c => c.UserId == userId).ToList();
        ...
        [Authorize]
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,ContactNumber")] Customer customer)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,ContactNumber")] Customer customer)
        {
            customer.UserId = User.Identity.GetUserId();
            ModelState.Clear();
            TryValidateModel(customer);
